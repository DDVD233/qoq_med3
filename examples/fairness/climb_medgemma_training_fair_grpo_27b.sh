...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/home/dvdai/orcd/scratch/high_modality/geom_train_no_demo.jsonl \
    ...
    actor_rollout_ref.model.path=google/medgemma-27b-it \
    ...
    ray_init.num_cpus=30 \
    trainer.critic_warmup=0 \
    trainer.logger='["console","wandb"]' \
    trainer.project_name='verl_climb' \
    trainer.experiment_name='medgemma_training_demo_fair_grpo_27b_nd_lowlr' \
